...
router.get('/get-user-by-id/:userId',VerifyToken,UserController.GetUserById);
...
router.get('/get-task-eligible-evaluators/:orgId',VerifyToken,UserController.getUsersByOrg);
